...
The `ndfc-collector` maintainers take all security issues in the project
seriously. Thank you for improving the security of `ndfc-collector`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`ndfc-collector` leverages GitHub's private vulnerability reporting.
